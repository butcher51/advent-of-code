const data = `...766.......821.547.....577......................................387.....................56..........446.793..........292..................
  ...
  for (let j = 0; j < row.length; j++) {
    ...
    if (!isNaN(value)) {
      ...
      numbers.push({
        ...
        validation: validate(i, j - number.length, number.length),
      });
      number = "";
    }
    if (j === row.length - 1 && number !== "") {
      numbers.push({
        number,
        x: i,
        y: j - number.length,
...
for (let j = 0; j < numbers.length; j++) {
  ...
  for (let i = 0; i < numbers.length; i++) {
    const numberB = numbers[i];
    if (
      numberA.number != numberB.number &&
      numberA.validation.gear &&
      numberB.validation.gear &&
      numberA.validation.gear.x === numberB.validation.gear.x &&
      numberA.validation.gear.y === numberB.validation.gear.y
    ) {
      if (
        gearPairs.some(
          (pair) =>
            pair.a.number === numberB.number && pair.b.number === numberA.number
        )
      ) {
        continue;
      }
...
fs.writeFileSync("day3_gears.json", JSON.stringify(gearPairs, null, 2));
...
gearPairs.forEach((pair) => {
  sum += parseInt(parseInt(pair.a.number) * parseInt(pair.b.number));
});
